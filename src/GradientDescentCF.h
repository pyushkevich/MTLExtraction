#ifndef _GradientDescentCF_h
#define _GradientDescentCF_h

#include "itkSingleValuedCostFunction.h"
#include "itkGradientDescentOptimizer.h"


class CylinderGradientCF : public itk::SingleValuedCostFunction
{
public:
	...
	using Self = CylinderGradientCF;
	using Superclass = itk::SingleValuedCostFunction;
	using Pointer = itk::SmartPointer<Self>;
	using ConstPointer = itk::SmartPointer<const Self>;
	itkNewMacro(Self);
	itkTypeMacro(CylinderGradientCF, SingleValuedCostFunction);
